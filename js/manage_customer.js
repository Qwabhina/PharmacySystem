...
function updateCustomer(id) {
  ...
  if(!validateName(customer_name.value, "name_error"))
    ...
    xhttp.open("GET", "php/manage_customer.php?action=update&id=" + id + "&name=" + customer_name.value + "&contact_number=" + contact_number.value + "&address=" + customer_address.value, true);
    xhttp.send();
  }
}
